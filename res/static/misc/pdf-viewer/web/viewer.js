  ...
  PDFPageView.prototype = {
    ...
    cssTransform: function PDFPageView_transform(canvas, redrawAnnotations) {
      ...
      if (this.textLayer) {
        ...
        //  : This could probably be simplified by drawing the text layer in
...
var PDFViewerApplication = {
  ...
  initialize: function pdfViewInitialize() {
    ...
    var initializedPromise = Promise.all([
      ...
      //   move more preferences and other async stuff here
  ...
  //  (mack): This function signature should really be pdfViewOpen(url, args)
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
    ...
    //  (robwu): Use named pages when size calculation bugs get resolved
